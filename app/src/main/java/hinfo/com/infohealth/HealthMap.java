...
public class HealthMap extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    Intent itLogin, itMaps, itGallery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itMaps = new Intent(this, Maps.class);
        itGallery = new Intent(this, Gallery.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.health_map, menu);
        return true;
    }
